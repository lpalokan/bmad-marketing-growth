...
2. Confirm company-context exists: `{output_folder}/company-context/icp.md`, `positioning.md`, `kpis.md`. Read whichever are present and note what is absent. Only if none exists anywhere in the project, suggest `/company-context-bootstrap` and ask whether to continue without it.
